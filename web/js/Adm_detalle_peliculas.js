...
function cargarDetallePeliculas() {
    ...
    if (!$.fn.DataTable.isDataTable('#tablax')) {
        $('#tablax').DataTable({
            responsive: true,
            ajax: {
                url: '../ControladorPeli?tipoc=AdministrarDetallesPeliculas&accion=mostrar',
                method: 'GET',
                dataSrc: '',
...
function cargarPeliculas() {
    $.ajax({
        url: '../ControladorPeli?tipoc=AdministrarDetallesPeliculas&estadoPeli=pelicula',
        method: 'GET',
        dataType: 'json',
        success: function (data) {
            estad('#pelicula2', data, 'Selecciona una película');
...
function cargarSede() {
    $.ajax({
        url: '../ControladorPeli?tipoc=AdministrarDetallesPeliculas&estadoPeli=sede',
        method: 'GET',
        dataType: 'json',
        success: function (data) {
            estad('#sede2', data, 'Selecciona una sede');
...
function cargarHora() {
    $.ajax({
        url: '../ControladorPeli?tipoc=AdministrarDetallesPeliculas&estadoPeli=hora',
        method: 'GET',
        dataType: 'json',
        success: function (data) {
            estad('#hora2', data, 'Selecciona una hora');
...
function cargarCategoria() {
    $.ajax({
        url: '../ControladorPeli?tipoc=AdministrarDetallesPeliculas&estadoPeli=categoria',
        method: 'GET',
        dataType: 'json',
        success: function (data) {
            estad('#categoria2', data, 'Selecciona una categoría');
...
function cargarDia() {
    $.ajax({
        url: '../ControladorPeli?tipoc=AdministrarDetallesPeliculas&estadoPeli=dia',
        method: 'GET',
        dataType: 'json',
        success: function (data) {
            estad2('#dia2', data, 'Selecciona un día');
...
function cargarVista() {
    $.ajax({
        url: '../ControladorPeli?tipoc=AdministrarDetallesPeliculas&estadoPeli=vista',
        method: 'GET',
        dataType: 'json',
        success: function (data) {
            estad('#vista2', data, 'Selecciona una vista');
