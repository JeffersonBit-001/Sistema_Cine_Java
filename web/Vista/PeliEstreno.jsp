...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="../css/PeliCarEst.css"/>
    </head>
    <body>
        ...
        <div class="jumbotron jumbotron-fluid bg-jumbotron" style="margin-bottom: 90px;">
            <div class="container text-center py-5">
                <h3 class="text-white display-3 mb-4">Películas en<br> Estreno</h3>
                <div class="d-inline-flex align-items-center text-white flex_what">
                    ...
                    <p class="m-0">Películas en Estreno</p>
                </div>
            </div>
        </div>
            ...
            <center>
                ...
                <content class="content_section_selector_bodypelis">
                    ...
                    <section class="peliculas_cartelera_body">
                        ...
                        <h2 id="titulo_cartelera_body">ESTRENOS</h2>
                        <hr>
                        ...
                        <a href="#" onclick="cargar('../ControladorPeli?tipoc=Estreno');">Regresar</a>
