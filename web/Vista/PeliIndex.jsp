    ...
    <body>
        ...
        <div class="jumbotron jumbotron-fluid bg-jumbotron" style="margin-bottom: 90px;">
            <div class="container text-center py-5">
                <h3 class="text-white display-3 mb-4">Películas en<br> Tendencia</h3>
                <div class="d-inline-flex align-items-center text-white flex_what">
                    ...
                    <p class="m-0">Películas en Tendencia</p>
                </div>
            </div>
        </div>
     ...
     <script src="<%= request.getContextPath()%>/js/PeliIndex.js"></script>
