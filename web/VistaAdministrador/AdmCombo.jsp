    ...
    <body>
                ...
                <div class="sidebar-content js-simplebar">
                    ...
                    <ul class="sidebar-nav">
                        ...
                        <li class="sidebar-item">
                            ...
                            <ul class="collapse show" id="dashboard-submenu3">
            ...
            <div class="main">
                ...
                <div class="app-content-header bg-dark app_container">
                    <div class="container-fluid containt_title">
                        <div class="row">
                            <div class="col-sm-6">
                                <span class="align-middle peli_align_text">Combos</span>
                            </div>
                            <div class="col-sm-6">
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <!-- FORMULARIO -->
                                    <c:if test="${'agregarModalCombos'.equals(requestScope.agregarModal)}">
                                        <form action="<%=request.getContextPath()%>/ControlComb?tipoc=${estados_contralador}" method="post" enctype="multipart/form-data">
                                    ...
                                    <c:if test="${'agregarDetallesCombos'.equals(requestScope.agregarModal)}">
                                        <form action="<%= request.getContextPath()%>/ControlComb?tipoc=${estados_contralador}" method="post">
                                            ...
                                            <div class="mb-2">
                                                ...
                                                <select class="form-select" name="combo2" id="combo2" aria-label="Floating label select example">
                                                    ...
                                                    <c:forEach items="${combos_cat}" var="item">
                                            ...
                                            <div class="mb-2">
                                                ...
                                                <select class="form-select" name="categoria2" id="categoria2" aria-label="Floating label select example">
                                                    <option selected>--Selecciona--</option>
                                                    <c:forEach items="${categoria_combos}" var="item">
                                                        <option value="${item.id}">${item.nombre}</option>
                                                    </c:forEach>
                                            ...
                                            <div class="mb-2">
                                                ...
                                                <select class="form-select" name="sede2" id="sede2" aria-label="Floating label select example">
                                                    <option selected>--Selecciona--</option>
                                                    <c:forEach items="${sedes_cat}" var="item">
                                                        <option value="${item.id}">${item.nombre}</option>
                                                    </c:forEach>
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <c:if test="${'modificarModalCombos'.equals(requestScope.modificarModal)}">
                                        <form action="<%=request.getContextPath()%>/ControlComb?tipoc=${estados_contralador}" method="post" enctype="multipart/form-data">
                                    ...
                                    <c:if test="${'modificarModalDetallesCombos'.equals(requestScope.modificarModal)}">
                                        <form action="<%=request.getContextPath()%>/ControlComb?tipoc=${estados_contralador}" method="post">
                                        ...
                                        <tbody class="tbody_cuerpo table-group-divider">
                                            ...
                                            <c:forEach items="${datos}" var="item">   
                                                <tr>
                                                    ...
                                                    <td>${item.abastece}</td>
                                                    <td>
                                                        <img src="<%=request.getContextPath()%>/img/${item.imagen}" width="100px" height="100px"alt="alt"/>
                                                    </td>
                                                    <td>${item.sinopsis}</td>
                                                    <td>${item.precio}</td>
                                                    <td>${item.oferta}</td>
                                                    ...
                                                    <td>
                                                        <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                                            ...
                                                            <a href="<%=request.getContextPath()%>/ControlComb?tipoc=${estados_contralador}&id=${item.id}&accion=delete" type="button" class="btn btn-warning" value="${item.id}">
        ...
        <script>
            function cargarDatos(id) {
                $.ajax({
                    url: '<%=request.getContextPath()%>/ControlComb?tipoc=${estados_contralador}&accion=update&id=' + id,
                    method: 'GET',
                    success: function (data) {
                        $('#id').val(data.id);
                        $('#nombre').val(data.nombre);
                        $('#abastece').val(data.abastece);
                        $('#sinopsis').val(data.sinopsis);
                        $('#precio').val(data.precio);
                        $('#oferta').val(data.oferta);
                        $("#vistaPreviaImagen").attr("src", "<%= request.getContextPath()%>/img/" + data.imagen);
                    },
                    error: function () {
            ...
            function cargarDatos2(id) {
                $.ajax({
                    ...
                    success: function (data) {
                        $('#id2').val(data.id);
                        $('#combo').val(data.idcombo);
                        $('#categoriax').val(data.idcat);
                        $('#sedex').val(data.idsede);
                    },
                    error: function () {
                        alert('Error al cargar datos');
                    }
