...
<html>
                    ...
                    <table id="tablax" class="table table-hover border-top-color-black display nowrap" style="width:100%">
                        <thead class="table-dark">
                            <tr>
                                ...
                                <th scope="col">Cantidad butacas</th>
                                <th scope="col">Total Precio Combos</th>
                                <th scope="col">Total Neto</th>
                                <th scope="col">Codigo Aleatorio</th>
    ...
    <script src="<%= request.getContextPath()%>/js/Adm_Reservaciones.js" type="text/javascript"></script>
