...
<html>
    ...
    <body>
        ...
        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#agregarModal" data-bs-whatever="@mdo">Agregar Cliente</button>
    ...
    <script src="<%= request.getContextPath()%>/js/Adm_clientes.js" type="text/javascript"></script>
