...
<html>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form id ="form_agg" action="<%= request.getContextPath()%>/ControladorPeli?tipoc=${estados_contralador}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mb-2">
                                <label for="floatingSelect">Número Asiento</label>
                                <select class="form-select" name="asientos2" id="asientos2" aria-label="Floating label select example">
                            ...
                            <div class="mb-2">
                                <label for="floatingSelect">Categoria Asiento</label>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form id="formUpdate" action="<%=request.getContextPath()%>/ControladorPeli?tipoc=${estados_contralador}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mb-2">
                                <label for="floatingSelect">Número Asiento</label>
                                <select class="form-select" name="asientos" id="asientos" aria-label="Floating label select example">
                                    <option selected>--Selecciona--</option>
    ...
    <script src="<%= request.getContextPath()%>/js/Adm_AAsientos.js" type="text/javascript"></script>
