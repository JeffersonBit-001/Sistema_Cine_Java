 ...
 * @author JEFFERSON
 */
public class ControladorSlader extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        response.setContentType("text/html;charset=UTF-8");
            ...
            if (active != null) {
                ArrayList<PeliIndex> tipo = pel.obtenerPeliculasSlider();
            ...
            /*request.setAttribute("index_env", pel.obtenerPeliculasSlider());
