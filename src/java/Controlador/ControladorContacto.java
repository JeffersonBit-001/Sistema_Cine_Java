...
public class ControladorContacto extends HttpServlet {
    ...
    ContactoDao contac = new ContactoDao();
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String respuesta = contac.insertarContacto(nombre, correo, sub, mess);
        if (!respuesta.equals("")) {
        ...
        //request.getRequestDispatcher("Vista/contact.jsp").forward(request, response);
    }
