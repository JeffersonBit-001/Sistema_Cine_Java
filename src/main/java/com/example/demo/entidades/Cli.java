...
public class Cli {
    ...
    public Cli(Long id, String correo, String pass, String nombres, String apellidos, String dni, String genero, String nacimiento, String cel, String domicilio, String correo_confirm, String pass_confirm) {
        this.id = id;
        this.correo = correo;
        this.pass = pass;
